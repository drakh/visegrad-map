...
var FilterWin = new Class({
	...
	}, graph_bind_events: function (el)
	{
		...
		console.log(d);
		for (var gr = this.gr, p = this.g_data.g, map = this.g_data.d, u = this.g_data.u, s = el.getElements(".ct-series"), l = s.length, l1 = l - 1, i = 0; l > i; i++)
		{
	...
	{
		var f = this.filt_arr, data = this.f_data;
