...
alpha:"Prosimy używać tylko liter (a-z) w tym polu. Spacje oraz inne znaki są niedozwolone.",alphanum:"Prosimy używać tylko liter (a-z) lub liczb (0-9) w tym polu. Spacje oraz inne znaki są niedozwolone.",dateSuchAs:"Prosimy podać prawidłową datę w formacie: {date}",dateInFormatMDY:'Prosimy podać poprawną date w formacie DD.MM.RRRR (i.e. "12.01.2009")',email:'Prosimy podać prawidłowy adres e-mail, np. "jan@domena.pl".',url:"Prosimy podać prawidłowy adres URL, np. http://www.example.com.",currencyDollar:"Prosimy podać prawidłową sumę w PLN. Dla przykładu: 100.00 PLN.",oneRequired:"Prosimy wypełnić chociaż jedno z pól.",errorPrefix:"Błąd: ",warningPrefix:"Uwaga: ",noSpace:"W tym polu nie mogą znajdować się spacje.",reqChkByNode:"Brak zaznaczonych elementów.",requiredChk:"To pole jest wymagane.",reqChkByName:"Prosimy wybrać z {label}.",match:"To pole musi być takie samo jak {matchName}",startDate:"data początkowa",endDate:"data końcowa",currentDate:"aktualna data",afterDate:"Podana data poinna być taka sama lub po {label}.",beforeDate:"Podana data poinna być taka sama lub przed {label}.",startMonth:"Prosimy wybrać początkowy miesiąc.",sameMonth:"Te dwie daty muszą być w zakresie tego samego miesiąca - wymagana jest zmiana któregoś z pól."}),Locale.define("pt-PT","Date",{months:["Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"],months_abbr:["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"],days:["Domingo","Segunda-feira","Terça-feira","Quarta-feira","Quinta-feira","Sexta-feira","Sábado"],days_abbr:["Dom","Seg","Ter","Qua","Qui","Sex","Sáb"],dateOrder:["date","month","year"],shortDate:"%d-%m-%Y",shortTime:"%H:%M",AM:"AM",PM:"PM",firstDayOfWeek:1,ordinal:"º",lessThanMinuteAgo:"há menos de um minuto",minuteAgo:"há cerca de um minuto",minutesAgo:"há {delta} minutos",hourAgo:"há cerca de uma hora",hoursAgo:"há cerca de {delta} horas",dayAgo:"há um dia",daysAgo:"há {delta} dias",weekAgo:"há uma semana",weeksAgo:"há {delta} semanas",monthAgo:"há um mês",monthsAgo:"há {delta} meses",yearAgo:"há um ano",yearsAgo:"há {delta} anos",lessThanMinuteUntil:"em menos de um minuto",minuteUntil:"em um minuto",minutesUntil:"em {delta} minutos",hourUntil:"em uma hora",hoursUntil:"em {delta} horas",dayUntil:"em um dia",daysUntil:"em {delta} dias",weekUntil:"em uma semana",weeksUntil:"em {delta} semanas",monthUntil:"em um mês",monthsUntil:"em {delta} meses",yearUntil:"em um ano",yearsUntil:"em {delta} anos"}),Locale.define("pt-BR","Date",{shortDate:"%d/%m/%Y"}).inherit("pt-PT","Date"),Locale.define("pt-BR","FormValidator",{required:"Este campo é obrigatório.",minLength:"Digite pelo menos {minLength} caracteres (tamanho atual: {length}).",maxLength:"Não digite mais de {maxLength} caracteres (tamanho atual: {length}).",integer:"Por favor digite apenas um número inteiro neste campo. Não são permitidos números decimais (por exemplo, 1,25).",numeric:'Por favor digite apenas valores numéricos neste campo (por exemplo, "1" ou "1.1" ou "-1" ou "-1,1").',digits:"Por favor use apenas números e pontuação neste campo (por exemplo, um número de telefone com traços ou pontos é permitido).",alpha:"Por favor use somente letras (a-z). Espaço e outros caracteres não são permitidos.",alphanum:"Use somente letras (a-z) ou números (0-9) neste campo. Espaço e outros caracteres não são permitidos.",dateSuchAs:"Digite uma data válida, como {date}",dateInFormatMDY:'Digite uma data válida, como DD/MM/YYYY (por exemplo, "31/12/1999")',email:'Digite um endereço de email válido. Por exemplo "nome@dominio.com".',url:"Digite uma URL válida. Exemplo: http://www.example.com.",currencyDollar:"Digite um valor em dinheiro válido. Exemplo: R$100,00 .",oneRequired:"Digite algo para pelo menos um desses campos.",errorPrefix:"Erro: ",warningPrefix:"Aviso: ",noSpace:"Não é possível digitar espaços neste campo.",reqChkByNode:"Não foi selecionado nenhum item.",requiredChk:"Este campo é obrigatório.",reqChkByName:"Por favor digite um {label}.",match:"Este campo deve ser igual ao campo {matchName}.",startDate:"a data inicial",endDate:"a data final",currentDate:"a data atual",afterDate:"A data deve ser igual ou posterior a {label}.",beforeDate:"A data deve ser igual ou anterior a {label}.",startMonth:"Por favor selecione uma data inicial.",sameMonth:"Estas duas datas devem ter o mesmo mês - você deve modificar uma das duas.",creditcard:"O número do cartão de crédito informado é inválido. Por favor verifique o valor e tente novamente. {length} números informados."}),Locale.define("pt-BR","Number",{decimal:",",group:".",currency:{prefix:"R$ "}}),Locale.define("pt-PT","FormValidator",{required:"Este campo é necessário.",minLength:"Digite pelo menos{minLength} caracteres (comprimento {length} caracteres).",maxLength:"Não insira mais de {maxLength} caracteres (comprimento {length} caracteres).",integer:"Digite um número inteiro neste domínio. Com números decimais (por exemplo, 1,25), não são permitidas.",numeric:'Digite apenas valores numéricos neste domínio (p.ex., "1" ou "1.1" ou "-1" ou "-1,1").',digits:"Por favor, use números e pontuação apenas neste campo (p.ex., um número de telefone com traços ou pontos é permitida).",alpha:"Por favor use somente letras (a-z), com nesta área. Não utilize espaços nem outros caracteres são permitidos.",alphanum:"Use somente letras (a-z) ou números (0-9) neste campo. Não utilize espaços nem outros caracteres são permitidos.",dateSuchAs:"Digite uma data válida, como {date}",dateInFormatMDY:'Digite uma data válida, como DD/MM/YYYY (p.ex. "31/12/1999")',email:'Digite um endereço de email válido. Por exemplo "fred@domain.com".',url:"Digite uma URL válida, como http://www.example.com.",currencyDollar:"Digite um valor válido $. Por exemplo $ 100,00. ",oneRequired:"Digite algo para pelo menos um desses insumos.",errorPrefix:"Erro: ",warningPrefix:"Aviso: "}),function(){var pluralize=function(n,one,few,many,other){var modulo10=n%10,modulo100=n%100;return 1==modulo10&&11!=modulo100?one:2!=modulo10&&3!=modulo10&&4!=modulo10||12==modulo100||13==modulo100||14==modulo100?0==modulo10||5==modulo10||6==modulo10||7==modulo10||8==modulo10||9==modulo10||11==modulo100||12==modulo100||13==modulo100||14==modulo100?many:other:few};Locale.define("ru-RU","Date",{months:["Январь","Февраль","Март","Апрель","Май","Июнь","Июль","Август","Сентябрь","Октябрь","Ноябрь","Декабрь"],months_abbr:["янв","февр","март","апр","май","июнь","июль","авг","сент","окт","нояб","дек"],days:["Воскресенье","Понедельник","Вторник","Среда","Четверг","Пятница","Суббота"],days_abbr:["Вс","Пн","Вт","Ср","Чт","Пт","Сб"],dateOrder:["date","month","year"],shortDate:"%d.%m.%Y",shortTime:"%H:%M",AM:"AM",PM:"PM",firstDayOfWeek:1,ordinal:"",lessThanMinuteAgo:"меньше минуты назад",minuteAgo:"минуту назад",minutesAgo:function(delta){return"{delta} "+pluralize(delta,"минуту","минуты","минут")+" назад"},hourAgo:"час назад",hoursAgo:function(delta){return"{delta} "+pluralize(delta,"час","часа","часов")+" назад"},dayAgo:"вчера",daysAgo:function(delta){return"{delta} "+pluralize(delta,"день","дня","дней")+" назад"},weekAgo:"неделю назад",weeksAgo:function(delta){return"{delta} "+pluralize(delta,"неделя","недели","недель")+" назад"},monthAgo:"месяц назад",monthsAgo:function(delta){return"{delta} "+pluralize(delta,"месяц","месяца","месяцев")+" назад"},yearAgo:"год назад",yearsAgo:function(delta){return"{delta} "+pluralize(delta,"год","года","лет")+" назад"},lessThanMinuteUntil:"меньше чем через минуту",minuteUntil:"через минуту",minutesUntil:function(delta){return"через {delta} "+pluralize(delta,"минуту","минуты","минут")},hourUntil:"через час",hoursUntil:function(delta){return"через {delta} "+pluralize(delta,"час","часа","часов")},dayUntil:"завтра",daysUntil:function(delta){return"через {delta} "+pluralize(delta,"день","дня","дней")},weekUntil:"через неделю",weeksUntil:function(delta){return"через {delta} "+pluralize(delta,"неделю","недели","недель")},monthUntil:"через месяц",monthsUntil:function(delta){return"через {delta} "+pluralize(delta,"месяц","месяца","месяцев")},yearUntil:"через",yearsUntil:function(delta){return"через {delta} "+pluralize(delta,"год","года","лет")}})}(),Locale.define("ru-RU","FormValidator",{required:"Это поле обязательно к заполнению.",minLength:"Пожалуйста, введите хотя бы {minLength} символов (Вы ввели {length}).",maxLength:"Пожалуйста, введите не больше {maxLength} символов (Вы ввели {length}).",integer:"Пожалуйста, введите в это поле число. Дробные числа (например 1.25) тут не разрешены.",numeric:'Пожалуйста, введите в это поле число (например "1" или "1.1", или "-1", или "-1.1").',digits:"В этом поле Вы можете использовать только цифры и знаки пунктуации (например, телефонный номер со знаками дефиса или с точками).",alpha:"В этом поле можно использовать только латинские буквы (a-z). Пробелы и другие символы запрещены.",alphanum:"В этом поле можно использовать только латинские буквы (a-z) и цифры (0-9). Пробелы и другие символы запрещены.",dateSuchAs:"Пожалуйста, введите корректную дату {date}",dateInFormatMDY:'Пожалуйста, введите дату в формате ММ/ДД/ГГГГ (например "12/31/1999")',email:'Пожалуйста, введите корректный емейл-адрес. Для примера "fred@domain.com".',url:"Пожалуйста, введите правильную ссылку вида http://www.example.com.",currencyDollar:"Пожалуйста, введите сумму в долларах. Например: $100.00 .",oneRequired:"Пожалуйста, выберите хоть что-нибудь в одном из этих полей.",errorPrefix:"Ошибка: ",warningPrefix:"Внимание: "}),function(){var pluralize=function(n,one,few,other){return 1==n?one:2==n||3==n||4==n?few:other};Locale.define("sk-SK","Date",{months:["Január","Február","Marec","Apríl","Máj","Jún","Júl","August","September","Október","November","December"],months_abbr:["januára","februára","marca","apríla","mája","júna","júla","augusta","septembra","októbra","novembra","decembra"],days:["Nedele","Pondelí","Úterý","Streda","Čtvrtek","Pátek","Sobota"],days_abbr:["ne","po","ut","st","št","pi","so"],dateOrder:["date","month","year"],shortDate:"%d.%m.%Y",shortTime:"%H:%M",AM:"dop.",PM:"pop.",firstDayOfWeek:1,ordinal:".",lessThanMinuteAgo:"pred chvíľou",minuteAgo:"približne pred minútou",minutesAgo:function(delta){return"pred {delta} "+pluralize(delta,"minútou","minútami","minútami")},hourAgo:"približne pred hodinou",hoursAgo:function(delta){return"pred {delta} "+pluralize(delta,"hodinou","hodinami","hodinami")},dayAgo:"pred dňom",daysAgo:function(delta){return"pred {delta} "+pluralize(delta,"dňom","dňami","dňami")},weekAgo:"pred týždňom",weeksAgo:function(delta){return"pred {delta} "+pluralize(delta,"týždňom","týždňami","týždňami")},monthAgo:"pred mesiacom",monthsAgo:function(delta){return"pred {delta} "+pluralize(delta,"mesiacom","mesiacmi","mesiacmi")},yearAgo:"pred rokom",yearsAgo:function(delta){return"pred {delta} "+pluralize(delta,"rokom","rokmi","rokmi")},lessThanMinuteUntil:"o chvíľu",minuteUntil:"približne o minútu",minutesUntil:function(delta){return"o {delta} "+pluralize(delta,"minútu","minúty","minúty")},hourUntil:"približne o hodinu",hoursUntil:function(delta){return"o {delta} "+pluralize(delta,"hodinu","hodiny","hodín")},dayUntil:"o deň",daysUntil:function(delta){return"o {delta} "+pluralize(delta,"deň","dni","dní")},weekUntil:"o týždeň",weeksUntil:function(delta){return"o {delta} "+pluralize(delta,"týždeň","týždne","týždňov")},monthUntil:"o mesiac",monthsUntil:function(delta){return"o {delta} "+pluralize(delta,"mesiac","mesiace","mesiacov")},yearUntil:"o rok",yearsUntil:function(delta){return"o {delta} "+pluralize(delta,"rok","roky","rokov")}})}(),Locale.define("sk-SK","FormValidator",{required:"Táto položka je povinná.",minLength:"Zadajte prosím aspoň {minLength} znakov (momentálne {length} znakov).",maxLength:"Zadajte prosím menej ako {maxLength} znakov (momentálne {length} znakov).",integer:"Zadajte prosím celé číslo. Desetinné čísla (napr. 1.25) nie sú povolené.",numeric:"Zadajte len číselné hodnoty (t.j. „1“ alebo „1.1“ alebo „-1“ alebo „-1.1“).",digits:"Zadajte prosím len čísla a interpunkčné znamienka (napríklad telefónne číslo s pomlčkami albo bodkami je povolené).",alpha:"Zadajte prosím len písmená (a-z). Medzery alebo iné znaky nie sú povolené.",alphanum:"Zadajte prosím len písmená (a-z) alebo číslice (0-9). Medzery alebo iné znaky nie sú povolené.",dateSuchAs:"Zadajte prosím platný dátum v tvare {date}",dateInFormatMDY:"Zadajte prosím platný datum v tvare MM / DD / RRRR (t.j. „12/31/1999“)",email:"Zadajte prosím platnú emailovú adresu. Napríklad „fred@domain.com“.",url:"Zadajte prosím platnoú adresu URL v tvare http://www.example.com.",currencyDollar:"Zadajte prosím platnú čiastku. Napríklad $100.00.",oneRequired:"Zadajte prosím aspoň jednu hodnotu z týchto položiek.",errorPrefix:"Chyba: ",warningPrefix:"Upozornenie: ",noSpace:"V tejto položle nie sú povolené medzery",reqChkByNode:"Nie sú vybrané žiadne položky.",requiredChk:"Táto položka je povinná.",reqChkByName:"Prosím vyberte {label}.",match:"Táto položka sa musí zhodovať s položkou {matchName}",startDate:"dátum začiatku",endDate:"dátum ukončenia",currendDate:"aktuálny dátum",afterDate:"Dátum by mal býť rovnaký alebo väčší ako {label}.",beforeDate:"Dátum by mal byť rovnaký alebo menší ako {label}.",startMonth:"Vyberte počiatočný mesiac.",sameMonth:"Tieto dva dátumy musia býť v rovnakom mesiaci - zmeňte jeden z nich.",creditcard:"Zadané číslo kreditnej karty je neplatné. Prosím, opravte ho. Bolo zadaných {length} číslic."}),function(){var pluralize=function(n,one,two,three,other){return n>=1&&3>=n?arguments[n]:other};Locale.define("sl-SI","Date",{months:["januar","februar","marec","april","maj","junij","julij","avgust","september","oktober","november","december"],months_abbr:["jan","feb","mar","apr","maj","jun","jul","avg","sep","okt","nov","dec"],days:["nedelja","ponedeljek","torek","sreda","četrtek","petek","sobota"],days_abbr:["ned","pon","tor","sre","čet","pet","sob"],dateOrder:["date","month","year"],shortDate:"%d.%m.%Y",shortTime:"%H.%M",AM:"AM",PM:"PM",firstDayOfWeek:1,ordinal:".",lessThanMinuteAgo:"manj kot minuto nazaj",minuteAgo:"minuto nazaj",minutesAgo:function(delta){return"{delta} "+pluralize(delta,"minuto","minuti","minute","minut")+" nazaj"},hourAgo:"uro nazaj",hoursAgo:function(delta){return"{delta} "+pluralize(delta,"uro","uri","ure","ur")+" nazaj"},dayAgo:"dan nazaj",daysAgo:function(delta){return"{delta} "+pluralize(delta,"dan","dneva","dni","dni")+" nazaj"},weekAgo:"teden nazaj",weeksAgo:function(delta){return"{delta} "+pluralize(delta,"teden","tedna","tedne","tednov")+" nazaj"},monthAgo:"mesec nazaj",monthsAgo:function(delta){return"{delta} "+pluralize(delta,"mesec","meseca","mesece","mesecov")+" nazaj"},yearthAgo:"leto nazaj",yearsAgo:function(delta){return"{delta} "+pluralize(delta,"leto","leti","leta","let")+" nazaj"},lessThanMinuteUntil:"še manj kot minuto",minuteUntil:"še minuta",minutesUntil:function(delta){return"še {delta} "+pluralize(delta,"minuta","minuti","minute","minut")},hourUntil:"še ura",hoursUntil:function(delta){return"še {delta} "+pluralize(delta,"ura","uri","ure","ur")},dayUntil:"še dan",daysUntil:function(delta){return"še {delta} "+pluralize(delta,"dan","dneva","dnevi","dni")},weekUntil:"še tedn",weeksUntil:function(delta){return"še {delta} "+pluralize(delta,"teden","tedna","tedni","tednov")},monthUntil:"še mesec",monthsUntil:function(delta){return"še {delta} "+pluralize(delta,"mesec","meseca","meseci","mesecov")},yearUntil:"še leto",yearsUntil:function(delta){return"še {delta} "+pluralize(delta,"leto","leti","leta","let")}})}(),Locale.define("sl-SI","FormValidator",{required:"To polje je obvezno",minLength:"Prosim, vnesite vsaj {minLength} znakov (vnesli ste {length} znakov).",maxLength:"Prosim, ne vnesite več kot {maxLength} znakov (vnesli ste {length} znakov).",integer:"Prosim, vnesite celo število. Decimalna števila (kot 1,25) niso dovoljena.",numeric:'Prosim, vnesite samo numerične vrednosti (kot "1" ali "1.1" ali "-1" ali "-1.1").',digits:"Prosim, uporabite številke in ločila le na tem polju (na primer, dovoljena je telefonska številka z pomišlaji ali pikami).",alpha:"Prosim, uporabite le črke v tem plju. Presledki in drugi znaki niso dovoljeni.",alphanum:"Prosim, uporabite samo črke ali številke v tem polju. Presledki in drugi znaki niso dovoljeni.",dateSuchAs:"Prosim, vnesite pravilen datum kot {date}",dateInFormatMDY:'Prosim, vnesite pravilen datum kot MM.DD.YYYY (primer "12.31.1999")',email:'Prosim, vnesite pravilen email naslov. Na primer "fred@domain.com".',url:"Prosim, vnesite pravilen URL kot http://www.example.com.",currencyDollar:"Prosim, vnesit epravilno vrednost €. Primer 100,00€ .",oneRequired:"Prosimo, vnesite nekaj za vsaj eno izmed teh polj.",errorPrefix:"Napaka: ",warningPrefix:"Opozorilo: ",noSpace:"To vnosno polje ne dopušča presledkov.",reqChkByNode:"Nič niste izbrali.",requiredChk:"To polje je obvezno",reqChkByName:"Prosim, izberite {label}.",match:"To polje se mora ujemati z poljem {matchName}",startDate:"datum začetka",endDate:"datum konca",currentDate:"trenuten datum",afterDate:"Datum bi moral biti isti ali po {label}.",beforeDate:"Datum bi moral biti isti ali pred {label}.",startMonth:"Prosim, vnesite začetni datum",sameMonth:"Ta dva datuma morata biti v istem mesecu - premeniti morate eno ali drugo.",creditcard:"Številka kreditne kartice ni pravilna. Preverite številko ali poskusite še enkrat. Vnešenih {length} znakov."}),Locale.define("sv-SE","Date",{months:["januari","februari","mars","april","maj","juni","juli","augusti","september","oktober","november","december"],months_abbr:["jan","feb","mar","apr","maj","jun","jul","aug","sep","okt","nov","dec"],days:["söndag","måndag","tisdag","onsdag","torsdag","fredag","lördag"],days_abbr:["sön","mån","tis","ons","tor","fre","lör"],dateOrder:["year","month","date"],shortDate:"%Y-%m-%d",shortTime:"%H:%M",AM:"",PM:"",firstDayOfWeek:1,ordinal:"",lessThanMinuteAgo:"mindre än en minut sedan",minuteAgo:"ungefär en minut sedan",minutesAgo:"{delta} minuter sedan",hourAgo:"ungefär en timme sedan",hoursAgo:"ungefär {delta} timmar sedan",dayAgo:"1 dag sedan",daysAgo:"{delta} dagar sedan",lessThanMinuteUntil:"mindre än en minut sedan",minuteUntil:"ungefär en minut sedan",minutesUntil:"{delta} minuter sedan",hourUntil:"ungefär en timme sedan",hoursUntil:"ungefär {delta} timmar sedan",dayUntil:"1 dag sedan",daysUntil:"{delta} dagar sedan"}),Locale.define("sv-SE","FormValidator",{required:"Fältet är obligatoriskt.",minLength:"Ange minst {minLength} tecken (du angav {length} tecken).",maxLength:"Ange högst {maxLength} tecken (du angav {length} tecken). ",integer:"Ange ett heltal i fältet. Tal med decimaler (t.ex. 1,25) är inte tillåtna.",numeric:'Ange endast numeriska värden i detta fält (t.ex. "1" eller "1.1" eller "-1" eller "-1,1").',digits:"Använd endast siffror och skiljetecken i detta fält (till exempel ett telefonnummer med bindestreck tillåtet).",alpha:"Använd endast bokstäver (a-ö) i detta fält. Inga mellanslag eller andra tecken är tillåtna.",alphanum:"Använd endast bokstäver (a-ö) och siffror (0-9) i detta fält. Inga mellanslag eller andra tecken är tillåtna.",dateSuchAs:"Ange ett giltigt datum som t.ex. {date}",dateInFormatMDY:'Ange ett giltigt datum som t.ex. YYYY-MM-DD (i.e. "1999-12-31")',email:'Ange en giltig e-postadress. Till exempel "erik@domain.com".',url:"Ange en giltig webbadress som http://www.example.com.",currencyDollar:"Ange en giltig belopp. Exempelvis 100,00.",oneRequired:"Vänligen ange minst ett av dessa alternativ.",errorPrefix:"Fel: ",warningPrefix:"Varning: ",noSpace:"Det får inte finnas några mellanslag i detta fält.",reqChkByNode:"Inga objekt är valda.",requiredChk:"Detta är ett obligatoriskt fält.",reqChkByName:"Välj en {label}.",match:"Detta fält måste matcha {matchName}",startDate:"startdatumet",endDate:"slutdatum",currentDate:"dagens datum",afterDate:"Datumet bör vara samma eller senare än {label}.",beforeDate:"Datumet bör vara samma eller tidigare än {label}.",startMonth:"Välj en start månad",sameMonth:"Dessa två datum måste vara i samma månad - du måste ändra det ena eller det andra."}),Locale.define("sv-SE","Number",{currency:{prefix:"SEK "}}).inherit("EU","Number"),Locale.define("tr-TR","Date",{months:["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"],months_abbr:["Oca","Şub","Mar","Nis","May","Haz","Tem","Ağu","Eyl","Eki","Kas","Ara"],days:["Pazar","Pazartesi","Salı","Çarşamba","Perşembe","Cuma","Cumartesi"],days_abbr:["Pa","Pzt","Sa","Ça","Pe","Cu","Cmt"],dateOrder:["date","month","year"],shortDate:"%d/%m/%Y",shortTime:"%H.%M",AM:"AM",PM:"PM",firstDayOfWeek:1,ordinal:"",lessThanMinuteAgo:"bir dakikadan önce",minuteAgo:"yaklaşık bir dakika önce",minutesAgo:"{delta} dakika önce",hourAgo:"bir saat kadar önce",hoursAgo:"{delta} saat kadar önce",dayAgo:"bir gün önce",daysAgo:"{delta} gün önce",weekAgo:"bir hafta önce",weeksAgo:"{delta} hafta önce",monthAgo:"bir ay önce",monthsAgo:"{delta} ay önce",yearAgo:"bir yıl önce",yearsAgo:"{delta} yıl önce",lessThanMinuteUntil:"bir dakikadan az sonra",minuteUntil:"bir dakika kadar sonra",minutesUntil:"{delta} dakika sonra",hourUntil:"bir saat kadar sonra",hoursUntil:"{delta} saat kadar sonra",dayUntil:"bir gün sonra",daysUntil:"{delta} gün sonra",weekUntil:"bir hafta sonra",weeksUntil:"{delta} hafta sonra",monthUntil:"bir ay sonra",monthsUntil:"{delta} ay sonra",yearUntil:"bir yıl sonra",yearsUntil:"{delta} yıl sonra"}),Locale.define("tr-TR","FormValidator",{required:"Bu alan zorunlu.",minLength:"Lütfen en az {minLength} karakter girin (siz {length} karakter girdiniz).",maxLength:"Lütfen en fazla {maxLength} karakter girin (siz {length} karakter girdiniz).",integer:"Lütfen bu alana sadece tamsayı girin. Ondalıklı sayılar (ör: 1.25) kullanılamaz.",numeric:'Lütfen bu alana sadece sayısal değer girin (ör: "1", "1.1", "-1" ya da "-1.1").',digits:"Lütfen bu alana sadece sayısal değer ve noktalama işareti girin (örneğin, nokta ve tire içeren bir telefon numarası kullanılabilir).",alpha:"Lütfen bu alanda yalnızca harf kullanın. Boşluk ve diğer karakterler kullanılamaz.",alphanum:"Lütfen bu alanda sadece harf ve rakam kullanın. Boşluk ve diğer karakterler kullanılamaz.",dateSuchAs:"Lütfen geçerli bir tarih girin (Ör: {date})",dateInFormatMDY:'Lütfen geçerli bir tarih girin (GG/AA/YYYY, ör: "31/12/1999")',email:'Lütfen geçerli bir email adresi girin. Ör: "kemal@etikan.com".',url:"Lütfen geçerli bir URL girin. Ör: http://www.example.com.",currencyDollar:"Lütfen geçerli bir TL miktarı girin. Ör: 100,00 TL .",oneRequired:"Lütfen en az bir tanesini doldurun.",errorPrefix:"Hata: ",warningPrefix:"Uyarı: ",noSpace:"Bu alanda boşluk kullanılamaz.",reqChkByNode:"Hiçbir öğe seçilmemiş.",requiredChk:"Bu alan zorunlu.",reqChkByName:"Lütfen bir {label} girin.",match:"Bu alan, {matchName} alanıyla uyuşmalı",startDate:"başlangıç tarihi",endDate:"bitiş tarihi",currentDate:"bugünün tarihi",afterDate:"Tarih, {label} tarihiyle aynı gün ya da ondan sonra olmalıdır.",beforeDate:"Tarih, {label} tarihiyle aynı gün ya da ondan önce olmalıdır.",startMonth:"Lütfen bir başlangıç ayı seçin",sameMonth:"Bu iki tarih aynı ayda olmalı - bir tanesini değiştirmeniz gerekiyor.",creditcard:"Girdiğiniz kredi kartı numarası geçersiz. Lütfen kontrol edip tekrar deneyin. {length} hane girildi."}),Locale.define("tr-TR","Number",{currency:{decimals:0,suffix:" TL"}}).inherit("EU","Number"),function(){var pluralize=function(n,one,few,many,other){var d=(n/10).toInt(),z=n%10;(n/100).toInt();return 1==d&&n>10?many:1==z?one:z>0&&5>z?few:many};Locale.define("uk-UA","Date",{months:["Січень","Лютий","Березень","Квітень","Травень","Червень","Липень","Серпень","Вересень","Жовтень","Листопад","Грудень"],months_abbr:["Січ","Лют","Бер","Квіт","Трав","Черв","Лип","Серп","Вер","Жовт","Лист","Груд"],days:["Неділя","Понеділок","Вівторок","Середа","Четвер","П'ятниця","Субота"],days_abbr:["Нд","Пн","Вт","Ср","Чт","Пт","Сб"],dateOrder:["date","month","year"],shortDate:"%d/%m/%Y",shortTime:"%H:%M",AM:"до полудня",PM:"по полудню",firstDayOfWeek:1,ordinal:"",lessThanMinuteAgo:"меньше хвилини тому",minuteAgo:"хвилину тому",minutesAgo:function(delta){return"{delta} "+pluralize(delta,"хвилину","хвилини","хвилин")+" тому"},hourAgo:"годину тому",hoursAgo:function(delta){return"{delta} "+pluralize(delta,"годину","години","годин")+" тому"},dayAgo:"вчора",daysAgo:function(delta){return"{delta} "+pluralize(delta,"день","дня","днів")+" тому"},weekAgo:"тиждень тому",weeksAgo:function(delta){return"{delta} "+pluralize(delta,"тиждень","тижні","тижнів")+" тому"},monthAgo:"місяць тому",monthsAgo:function(delta){return"{delta} "+pluralize(delta,"місяць","місяці","місяців")+" тому"},yearAgo:"рік тому",yearsAgo:function(delta){return"{delta} "+pluralize(delta,"рік","роки","років")+" тому"},lessThanMinuteUntil:"за мить",minuteUntil:"через хвилину",minutesUntil:function(delta){return"через {delta} "+pluralize(delta,"хвилину","хвилини","хвилин")},hourUntil:"через годину",hoursUntil:function(delta){return"через {delta} "+pluralize(delta,"годину","години","годин")},dayUntil:"завтра",daysUntil:function(delta){return"через {delta} "+pluralize(delta,"день","дня","днів")},weekUntil:"через тиждень",weeksUntil:function(delta){return"через {delta} "+pluralize(delta,"тиждень","тижні","тижнів")},monthUntil:"через місяць",monthesUntil:function(delta){return"через {delta} "+pluralize(delta,"місяць","місяці","місяців")},yearUntil:"через рік",yearsUntil:function(delta){return"через {delta} "+pluralize(delta,"рік","роки","років")}})}(),Locale.define("uk-UA","FormValidator",{required:"Це поле повинне бути заповненим.",minLength:"Введіть хоча б {minLength} символів (Ви ввели {length}).",maxLength:"Кількість символів не може бути більше {maxLength} (Ви ввели {length}).",integer:"Введіть в це поле число. Дробові числа (наприклад 1.25) не дозволені.",numeric:'Введіть в це поле число (наприклад "1" або "1.1", або "-1", або "-1.1").',digits:"В цьому полі ви можете використовувати лише цифри і знаки пунктіації (наприклад, телефонний номер з знаками дефізу або з крапками).",alpha:"В цьому полі можна використовувати лише латинські літери (a-z). Пробіли і інші символи заборонені.",alphanum:"В цьому полі можна використовувати лише латинські літери (a-z) і цифри (0-9). Пробіли і інші символи заборонені.",dateSuchAs:"Введіть коректну дату {date}.",dateInFormatMDY:'Введіть дату в форматі ММ/ДД/РРРР (наприклад "12/31/2009").',email:'Введіть коректну адресу електронної пошти (наприклад "name@domain.com").',url:"Введіть коректне інтернет-посилання (наприклад http://www.example.com).",currencyDollar:'Введіть суму в доларах (наприклад "$100.00").',oneRequired:"Заповніть одне з полів.",errorPrefix:"Помилка: ",warningPrefix:"Увага: ",noSpace:"Пробіли заборонені.",reqChkByNode:"Не відмічено жодного варіанту.",requiredChk:"Це поле повинне бути віміченим.",reqChkByName:"Будь ласка, відмітьте {label}.",match:"Це поле повинно відповідати {matchName}",startDate:"початкова дата",endDate:"кінцева дата",currentDate:"сьогоднішня дата",afterDate:"Ця дата повинна бути такою ж, або пізнішою за {label}.",beforeDate:"Ця дата повинна бути такою ж, або ранішою за {label}.",startMonth:"Будь ласка, виберіть початковий місяць",sameMonth:"Ці дати повинні відноситись одного і того ж місяця. Будь ласка, змініть одну з них.",creditcard:"Номер кредитної карти введений неправильно. Будь ласка, перевірте його. Введено {length} символів."}),Locale.define("zh-CHS","Date",{months:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],months_abbr:["一","二","三","四","五","六","七","八","九","十","十一","十二"],days:["星期日","星期一","星期二","星期三","星期四","星期五","星期六"],days_abbr:["日","一","二","三","四","五","六"],dateOrder:["year","month","date"],shortDate:"%Y-%m-%d",shortTime:"%I:%M%p",AM:"AM",PM:"PM",firstDayOfWeek:1,ordinal:"",lessThanMinuteAgo:"不到1分钟前",minuteAgo:"大约1分钟前",minutesAgo:"{delta}分钟之前",hourAgo:"大约1小时前",hoursAgo:"大约{delta}小时前",dayAgo:"1天前",daysAgo:"{delta}天前",weekAgo:"1星期前",weeksAgo:"{delta}星期前",monthAgo:"1个月前",monthsAgo:"{delta}个月前",yearAgo:"1年前",yearsAgo:"{delta}年前",lessThanMinuteUntil:"从现在开始不到1分钟",minuteUntil:"从现在开始約1分钟",minutesUntil:"从现在开始约{delta}分钟",hourUntil:"从现在开始1小时",hoursUntil:"从现在开始约{delta}小时",dayUntil:"从现在开始1天",daysUntil:"从现在开始{delta}天",weekUntil:"从现在开始1星期",weeksUntil:"从现在开始{delta}星期",monthUntil:"从现在开始一个月",monthsUntil:"从现在开始{delta}个月",yearUntil:"从现在开始1年",yearsUntil:"从现在开始{delta}年"}),Locale.define("zh-CHT","Date",{months:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],months_abbr:["一","二","三","四","五","六","七","八","九","十","十一","十二"],days:["星期日","星期一","星期二","星期三","星期四","星期五","星期六"],days_abbr:["日","一","二","三","四","五","六"],dateOrder:["year","month","date"],shortDate:"%Y-%m-%d",shortTime:"%I:%M%p",AM:"AM",PM:"PM",firstDayOfWeek:1,ordinal:"",lessThanMinuteAgo:"不到1分鐘前",minuteAgo:"大約1分鐘前",minutesAgo:"{delta}分鐘之前",hourAgo:"大約1小時前",hoursAgo:"大約{delta}小時前",dayAgo:"1天前",daysAgo:"{delta}天前",weekAgo:"1星期前",weeksAgo:"{delta}星期前",monthAgo:"1个月前",monthsAgo:"{delta}个月前",yearAgo:"1年前",yearsAgo:"{delta}年前",lessThanMinuteUntil:"從現在開始不到1分鐘",minuteUntil:"從現在開始約1分鐘",minutesUntil:"從現在開始約{delta}分鐘",hourUntil:"從現在開始1小時",hoursUntil:"從現在開始約{delta}小時",dayUntil:"從現在開始1天",daysUntil:"從現在開始{delta}天",weekUntil:"從現在開始1星期",weeksUntil:"從現在開始{delta}星期",monthUntil:"從現在開始一個月",monthsUntil:"從現在開始{delta}個月",yearUntil:"從現在開始1年",yearsUntil:"從現在開始{delta}年"}),Locale.define("zh-CHS","FormValidator",{required:"此项必填。",minLength:"请至少输入 {minLength} 个字符 (已输入 {length} 个)。",maxLength:"最多只能输入 {maxLength} 个字符 (已输入 {length} 个)。",integer:'请输入一个整数，不能包含小数点。例如："1", "200"。',numeric:'请输入一个数字，例如："1", "1.1", "-1", "-1.1"。',digits:"请输入由数字和标点符号组成的内容。例如电话号码。",alpha:"请输入 A-Z 的 26 个字母，不能包含空格或任何其他字符。",alphanum:"请输入 A-Z 的 26 个字母或 0-9 的 10 个数字，不能包含空格或任何其他字符。",dateSuchAs:"请输入合法的日期格式，如：{date}。",dateInFormatMDY:'请输入合法的日期格式，例如：YYYY-MM-DD ("2010-12-31")。',email:'请输入合法的电子信箱地址，例如："fred@domain.com"。',url:"请输入合法的 Url 地址，例如：http://www.example.com。",currencyDollar:"请输入合法的货币符号，例如：￥100.0",oneRequired:"请至少选择一项。",errorPrefix:"错误：",warningPrefix:"警告：",noSpace:"不能包含空格。",reqChkByNode:"未选择任何内容。",requiredChk:"此项必填。",reqChkByName:"请选择 {label}.",match:"必须与{matchName}相匹配",startDate:"起始日期",endDate:"结束日期",currentDate:"当前日期",afterDate:"日期必须等于或晚于 {label}.",beforeDate:"日期必须早于或等于 {label}.",startMonth:"请选择起始月份",sameMonth:"您必须修改两个日期中的一个，以确保它们在同一月份。",creditcard:"您输入的信用卡号码不正确。当前已输入{length}个字符。"}),Locale.define("zh-CHT","FormValidator",{required:"此項必填。 ",minLength:"請至少輸入{minLength} 個字符(已輸入{length} 個)。 ",maxLength:"最多只能輸入{maxLength} 個字符(已輸入{length} 個)。 ",integer:'請輸入一個整數，不能包含小數點。例如："1", "200"。 ',numeric:'請輸入一個數字，例如："1", "1.1", "-1", "-1.1"。 ',digits:"請輸入由數字和標點符號組成的內容。例如電話號碼。 ",alpha:"請輸入AZ 的26 個字母，不能包含空格或任何其他字符。 ",alphanum:"請輸入AZ 的26 個字母或0-9 的10 個數字，不能包含空格或任何其他字符。 ",dateSuchAs:"請輸入合法的日期格式，如：{date}。 ",dateInFormatMDY:'請輸入合法的日期格式，例如：YYYY-MM-DD ("2010-12-31")。 ',email:'請輸入合法的電子信箱地址，例如："fred@domain.com"。 ',url:"請輸入合法的Url 地址，例如：http://www.example.com。 ",currencyDollar:"請輸入合法的貨幣符號，例如：￥100.0",oneRequired:"請至少選擇一項。 ",errorPrefix:"錯誤：",warningPrefix:"警告：",noSpace:"不能包含空格。 ",reqChkByNode:"未選擇任何內容。 ",requiredChk:"此項必填。 ",reqChkByName:"請選擇 {label}.",match:"必須與{matchName}相匹配",startDate:"起始日期",endDate:"結束日期",currentDate:"當前日期",afterDate:"日期必須等於或晚於{label}.",beforeDate:"日期必須早於或等於{label}.",startMonth:"請選擇起始月份",sameMonth:"您必須修改兩個日期中的一個，以確保它們在同一月份。 ",creditcard:"您輸入的信用卡號碼不正確。當前已輸入{length}個字符。 "}),Form.Validator.add("validate-currency-yuan",{errorMsg:function(){return Form.Validator.getMsg("currencyYuan")},test:function(element){return Form.Validator.getValidator("IsEmpty").test(element)||/^￥?\-?([1-9]{1}[0-9]{0,2}(\,[0-9]{3})*(\.[0-9]{0,2})?|[1-9]{1}\d*(\.[0-9]{0,2})?|0(\.[0-9]{0,2})?|(\.[0-9]{1,2})?)$/.test(element.get("value"))}}),Locale.define("zh-CHS","Number",{currency:{prefix:"￥ "}}).inherit("en-US","Number"),Locale.define("zh-CHT").inherit("zh-CHS","Number"),Request.JSONP=new Class({Implements:[Chain,Events,Options],options:{onRequest:function(src){this.options.log&&window.console&&console.log&&console.log("JSONP retrieving script with url:"+src);
	...
	ID: {s: "Indonesia", lon: 113.921327, lat: -.789275, c: "ID"},
	...
	KE: {s: "Kenya", lon: 37.906193, lat: -.023559, c: "KE"},
	...
	NR: {s: "Nauru", lon: 166.931503, lat: -.522778, c: "NR"},
	...
	ST: {s: "Sao Tome and Principe", lon: 6.613081, lat: .18636, c: "ST"},
	...
	TG: {s: "Togo", lon: .824782, lat: 8.619543, c: "TG"},
	...
	Implements: [Events, Options], initialize: function (el, c, conf, options)
	{
		this.dtype = 0, this.setOptions(options), this.conf = conf, this.markers = [];
		var a_map = L.map($(mapid), {attributionControl: !1, zoomControl: !1, padding: [200, 200]});
		L.tileLayer(conf.url, {
			...
			minZoom: conf.min_z,
			maxZoom: conf.max_z
		}).addTo(a_map), this.pane = a_map.getPanes().popupPane, c && this.initialize_controls(c), this.cc_s_w = [
			"cities",
			"countries"
		], this.cc_s = 0, this.cc_switches = $$("#city-country a"), this.cc_switches_bind(), this.map = a_map, this.zoom_to_v4()
	}, set_dtype: function (i)
	{
		this.dtype = i
	}, cc_switches_bind: function ()
	{
		for (var cc = this.cc_switches, i = 0; i < cc.length; i++)cc[i].addEvent("click", this.cc_sw.bind(this, i));
		this.cc_sw(this.cc_s)
	}, cc_sw: function (i, e)
	{
		e && e.stop();
		for (var cc = this.cc_switches, j = 0; j < cc.length; j++)j == i ? (cc[j].removeClass("dark-bg"), cc[j].addClass("light-bg")) : (cc[j].removeClass("light-bg"), cc[j].addClass("dark-bg"));
		i != this.cc_s && (this.cc_s = i, this.redraw(i))
	}, initialize_controls: function (el)
	{
		var els = el.getElements("a");
		els[0].addEvent("click", this.zoom_to_bounds.bind(this)), els[1].addEvent("click", this.zoom_to_v4.bind(this)), els[2].addEvent("click", this.zoom_in.bind(this)), els[3].addEvent("click", this.zoom_out.bind(this))
	}, zoom_in: function (e)
	{
		e && e.stop(), this.map.zoomIn()
	}, zoom_out: function (e)
	{
		e && e.stop(), this.map.zoomOut()
	}, zoom_to_v4: function (e)
	{
		e && e.stop(), this.map.fitBounds(this.conf.v4_bounds)
	}, zoom_to_bounds: function (e)
	{
		e && e.stop(), this.bounds && this.map.fitBounds(this.bounds)
	}, redraw: function (i)
	{
		this.remove_markers();
		var w = this.cc_s_w[i], pts = this.pts_g, data = this.data, dt = data[w], pt_d = pts[w], max = DataUtil.get_max_len(dt), markers = [], pane = (this.options, this.pane), map = this.map, b_arr = [];
		for (var pid in pt_d)if (dt[pid] && dt[pid].length > 0)
		{
			var p = {pt: pt_d[pid], data: dt[pid]}, marker = new CityMarker(map, p, max, {
				pane: pane,
				onClick: this.show_graph.bind(this)
			});
			markers.include(marker), b_arr.include([p.pt.lat, p.pt.lon])
		}
		...
		if (markers.length > 0)
		{
			...
			z > conf.max_z && (z = conf.max_z), z < conf.min_z && (z = conf.min_z), map.options.minZoom = z, this.zoom_to_v4()
		}
	}, draw_points: function (data_in, points, f)
	{
		var pts_data = DataUtil.group_by_city(data_in), cts_data = DataUtil.group_by_country(data_in), data = {
			cities: pts_data,
			countries: cts_data
		}, pts = {cities: points, countries: countries_geo};
		this.pts_g = pts, this.data = data, this.graph_f = f, this.redraw(this.cc_s)
	}, show_graph: function (data)
	{
		var map = this.map, pane = this.pane, graph_f = this.graph_f;
		this.destroy_graph(map), console.log(data), this.graph = new GraphMarker(data, map, graph_f, {
			pane: pane,
	...
	{
		this.graph && this.graph.destroy(map)
	}, graph_destroyed: function ()
	{
		this.graph = null, this.fireEvent("graphdestroyed")
	}, remove_markers: function ()
	{
		for (var m = this.markers, map = this.map, i = 0; i < m.length; i++)m[i].destroy(map);
		this.markers = [], this.destroy_graph(map)
	}
}), BarGraph = new Class({
	Implements: [Events, Options], initialize: function (el, in_d, options)
	{
		this.setOptions(options), this.tips = new Tips, this.data = in_d;
		var ord = in_d.ord, y_d = in_d.y_d, c_d = in_d.c_d, unit = in_d.unit, l = [], r = [], r_p = [];
		for (var yr in y_d)l.include(yr);
		for (var y_d_c = DataUtil.count_arr_o(y_d, unit), c = 0; c < ord.length; c++)
		{
			var grd = {data: [], className: "graph-" + c % 17}, p_grd = [], cid = ord[c], c_y_d = {};
			if (c_d[cid])
			{
				var crd = c_d[cid];
				c_y_d = DataUtil.group_by_year(crd)
			}
			for (var i = 0; i < l.length; i++)if (grd.data[i] = 0, p_grd[i] = 0, c_y_d[l[i]])
			{
				var c_year = l[i], t = y_d_c[c_year], al = c_y_d[l[i]].length, am = 0;
				switch (unit)
				{
					case 0:
						am = al, p_grd[i] = am / (t.count / 100);
						break;
					case 1:
						am = 0;
						for (var ai = 0; al > ai; ai++)am += c_y_d[l[i]][ai].amount;
						p_grd[i] = am / (t.count / 100), am = Math.round(am / 1e3)
				}
				grd.data[i] = am
			}
			r_p[c] = p_grd, r[c] = grd
		}
		this.r_p = r_p, this.unit = unit;
		var g = new Chartist.Bar(el, {labels: l, series: r}, {stackBars: !0});
		g.on("created", this.graph_bind_events.bind(this, el))
	}, graph_bind_events: function (el)
	{
		for (var d = this.data, sw = d.g_g, r = this.r_p, unit = this.unit, s = el.getElements(".ct-series"), lns = [], i = 0; i < s.length; i++)for (var cid = d.ord[i], l = s[i].getElements(".ct-bar"), j = 0; j < l.length; j++)
		{
			var ad = ": " + r[i][j].round(2) + "% (of total " + (0 === unit ? "projects" : "money") + ")";
			switch (sw)
			{
				case"country":
					...
					break;
				case"c":
					l[j].store("tip:title", d.g_d[cid].n + ad), l[j].store("tip:text", d.g_d[cid].d);
					break;
				case"g":
		...
		this.tips && this.tips.attach(lns)
	}, destroy: function ()
	{
		this.tips.destroy()
	}
}), CityMarker = new Class({
	Implements: [Events, Options],
	options: {pane: null, front_z: 997, max_z: 996, min_z: 1},
	initialize: function (map, pt, b, options)
	{
		this.setOptions(options);
		var o = this.options, max_z = o.max_z, min_z = o.min_z;
		this.pt = pt;
		var a = Number.from(pt.data.length), w = Math.round(Math.log(a.map(0, b, 1.2, Math.E)) * mapconf.max_radius), z = Math.round(a.map(b, 0, min_z, max_z)), el = new Element("div", {
			title: pt.pt.s,
			styles: {position: "absolute", "z-index": z},
			events: {click: this.fire_click.bind(this)}
		}).inject(o.pane);
		new Element("div", {
			styles: {position: "absolute", width: 2 * w, height: 2 * w, left: -w, top: -w},
			"class": "marker-circle"
		}).inject(el), this.z = z, this.el = el, this.g = null, this.reposition(map), map.on("zoomstart", this.before_zoom.bind(this)), map.on("zoomend", this.reposition.bind(this, map))
	},
	fire_click: function ()
	{
	...
	to_front: function ()
	{
		this.el.setStyles({"z-index": this.options.front_z})
	},
	to_back: function ()
	{
		this.el.setStyles({"z-index": this.z})
	},
	...
	{
		var ps = map.latLngToLayerPoint([this.pt.pt.lat, this.pt.pt.lon]);
		this.el.setStyles({display: "block", transform: "translate3d(" + ps.x + "px, " + ps.y + "px, 0px)"})
	},
	destroy: function ()
	{
		this.el.destroy()
	...
	Implements: [Events, Options], initialize: function (el, options)
	{
		this.dtype = 0, this.setOptions(options), this.g = [], this.btns = [
			'<i class="el el-tasks"></i>',
			'<i class="el el-eur"></i>'
		], this.switches = [], this.unit = 0, this.build_switch(el);
		var w = new Element("div").inject(el);
		this.el = w
	}, set_dtype: function (i)
	{
		this.dtype = i, this.switch_units(0), this.switch_el.setStyles(0 == i ? {display: "block"} : {display: "none"})
	}, build_switch: function (el)
	{
		for (var w = new Element("div", {"class": "pure-menu pure-menu-horizontal"}).inject(el), ul = new Element("ul", {"class": "pure-menu-list"}).inject(w), btns = this.btns, i = 0; i < btns.length; i++)
		{
			var li = new Element("li", {"class": "pure-menu-item"}).inject(ul), a = new Element("a", {
				"class": "pure-button",
				html: btns[i],
		...
		this.switch_units(0), this.switch_el = w
	}, switch_units: function (i, e)
	{
		e && e.stop();
		for (var b = this.switches, j = 0; j < b.length; j++)j == i ? (b[j].removeClass("dark-bg"), b[j].addClass("light-bg")) : (b[j].removeClass("light-bg"), b[j].addClass("dark-bg"));
		this.unit != i && (this.unit = i, this.build_graphs())
	}, set_data: function (data, f)
	{
		this.f = f, this.data = data, this.build_graphs()
	}, destroy: function ()
	{
		for (var g = this.g, i = 0; i < g.length; i++)g[i].destroy();
		this.g = [], this.el.empty()
	}, build_graph_head: function (n)
	{
		var w = this.el, s = new Element("section", {"class": "graph-section"}).inject(w);
		new Element("header", {html: n}).inject(s);
		var grid = new Element("div", {"class": "pure-g"}).inject(s), pie = new Element("div", {"class": "pure-u-1 pure-u-md-1-3 ct-chart"}).inject(grid), bar = new Element("div", {"class": "pure-u-1 pure-u-md-2-3 ct-chart"}).inject(grid);
	...
	}, build_graphs: function ()
	{
		...
		{
			case 0:
				this.build_topic_graph(), this.build_tag_graph(), this.build_country_graph();
				break;
			case 1:
				this.build_topic_graph();
				break;
			case 2:
				this.build_tag_graph(), this.build_topic_graph()
		}
	}, build_topic_graph: function ()
	{
		...
		if (this.f)
		{
			var re = this.build_graph_head(mapconf.graph_names[dt][0]), data = this.data, f = this.f, g_d = {
				graph_data: data,
				graph_descs: f.g,
				graph_group: "g",
				unit: this.unit
			}, g = new PieGraph(re.pie, g_d);
			this.g.include(g);
			var s_d = g.get_g_data(), b = new BarGraph(re.bar, {
				ord: s_d.d,
	...
	}, build_tag_graph: function ()
	{
		...
		if (this.f)
		{
			var re = this.build_graph_head(mapconf.graph_names[dt][1]), data = this.data, f = this.f, g_d = {
				graph_data: data,
				graph_descs: f.c,
				graph_group: "c",
				unit: this.unit
	...
	{
		var dt = this.dtype, re = this.build_graph_head(mapconf.graph_names[dt][2]), data = this.data, g_d = {
			graph_data: data,
	...
	Implements: [Events, Options], initialize: function (el, options)
	{
		this.setOptions(options), this.pagination = {};
		var e = new Element("div", {"class": "pure-menu pure-menu-horizontal"}).inject(el);
		this.w = new Element("ul", {"class": "pure-menu-list"}).inject(e)
	}, set_data: function (p)
	{
		this.pagination = p, this.rebuild()
	}, rebuild: function ()
	{
		var p = this.pagination, page = p.page, w = this.w;
		w.empty();
		...
		if (page > 0)
		{
			...
			new Element("a", {
				...
				events: {click: this.change_page.bind(this, 0)}
			}).inject(li);
			var li = new Element("li", {"class": "pure-menu-item"}).inject(w);
			new Element("a", {
				html: '<i class="el el-backward"></i>',
				"class": "pure-button pure-menu-link",
				events: {click: this.change_page.bind(this, page - 1)}
			}).inject(li)
		}
		var start = page - 3;
		0 > start && (start = 0);
		var end = page + 3;
		0 == start && (end = start + 6), end > pages && (end = pages), end >= pages && (start = end - (6 - (pages - end))), 0 > start && (start = 0);
		for (var i = start; end >= i; i++)if (i == page)var li = new Element("li", {
		...
		else
		{
			...
			new Element("a", {
				html: i + 1,
				"class": "pure-button pure-menu-link",
				events: {click: this.change_page.bind(this, i)}
			}).inject(li)
		}
		if (pages > page)
		{
			...
			new Element("a", {
				...
				"class": "pure-button pure-menu-link",
				events: {click: this.change_page.bind(this, pages)}
			}).inject(li)
		}
		this.set_page()
	}, change_page: function (i, e)
	{
		e && e.stop(), this.pagination.page = i, this.rebuild()
	}, set_page: function ()
	{
	...
	options: {
		...
		], sort_els: {asc: '<i class="el el-caret-up"></i>', desc: '<i class="el el-caret-down"></i>'}
	},
	initialize: function (el, options)
	{
		this.dtype = 0, this.setOptions(options), this.pagination = {limit: 50, page: 0, count: 0}, this.wp = el;
		var t = new Element("table", {"class": "pure-table pure-table-bordered pure-table-striped"}).inject(el);
		this.tbl = t, this.bld_t(), this.pager = new DPager(el, {onPagechanged: this.change_page.bind(this)})
	},
	bld_t: function ()
	{
		var t = this.tbl;
		t.empty(), this.build_head(t), this.el = new Element("tbody").inject(t)
	},
	set_dtype: function (i)
	{
		this.dtype = i, this.wp.setStyles(1 == i ? {display: "none"} : {display: "block"}), this.bld_t()
	},
	build_head: function (t)
	{
		var h = new Element("thead").inject(t), r = new Element("tr").inject(h), o = this.options, ho = o.table_headers, se = o.sort_els, hal = 0;
		0 != this.dtype && (hal = 1);
		for (var i = 0; i < ho.length - hal; i++)
		{
			var th = new Element("th").inject(r), e = new Element("div", {"class": "pure-menu pure-menu-horizontal"}).inject(th);
			...
			for (var pid in se)
			{
				...
				new Element("a", {
					html: se[pid],
					"class": "pure-button pure-menu-link",
					events: {click: this.sort_table.bind(this, {col: ho[i], sort_type: pid})}
				}).inject(li)
			}
		}
	},
	...
	{
		this.pagination.page = 0, this.pagination.count = data.length, this.table_data = data, this.pager.set_data(this.pagination)
	},
	change_page: function (p)
	{
		this.pagination = p, this.fill_table()
	},
	sort_table: function (o, e)
	{
		e && e.stop();
		var st = "";
		switch ("desc" == o.sort_type && (st = "DESC_"), o.col.type)
		{
			case"s":
				st += "STRING";
				break;
		...
		this.table_data.sortOn(o.col.pid, Array[st]), this.pager.change_page(0)
	},
	fill_table: function ()
	{
		var w = this.el;
		w.empty();
		var pg = this.pagination, d = this.table_data, min = pg.page * pg.limit, max = min + pg.limit, hal = 0;
		0 != this.dtype && (hal = 1), console.log(hal);
		var ho = this.options.table_headers;
		max > d.length && (max = d.length);
		for (var i = min; max > i; i++)
		{
			for (var r = new Element("tr"), j = 0; j < ho.length - hal; j++)
			{
				var pid = ho[j].pid;
...
var DataUtil = {
	...
	{
		for (var d = this.count_arr(data, w), r = {}, i = 0; i < d.length; i++)
		{
			var e = d[i];
			r[e.pid] = {count: e.count, p: e.p}
		}
		return r
	}, count_arr: function (data, w)
	{
		...
		for (var pid in data)
		{
			var a = data[pid], l = a.length;
			switch (w)
			{
				case 0:
					total += data[pid].length, r.include({pid: pid, count: l, p: 0});
					break;
				case 1:
					for (var c = 0, i = 0; l > i; i++)c += a[i].amount;
					r.include({pid: pid, count: c, p: 0}), total += c
			}
		}
		for (var i = 0; i < r.length; i++)r[i].p = r[i].count / (total / 100);
		return r
	...
	}, group_by_country: function (data)
	{
		...
		{
			var d = data[i];
			r[d.country] || (r[d.country] = []), r[d.country].include(d)
		}
		return r
	}, group_by_year: function (data)
	{
		...
		{
			var d = data[i];
			r[d.year] || (r[d.year] = []), r[d.year].include(d)
		}
		return r
	}, group_by_city: function (data)
	{
		...
		{
			var d = data[i];
			r[d.pt_id] || (r[d.pt_id] = []), r[d.pt_id].include(d)
		}
		return r
	}, group_by_c: function (data)
	{
		for (var r = {}, i = 0; i < data.length; i++)for (var d = data[i], j = 0; j < d.c.length; j++)
		{
			var dc = d.c[j];
			r[dc] || (r[dc] = []), r[dc].include(d)
		}
		return r
	}, group_by_g: function (data)
	{
		...
		{
			var d = data[i];
			r[d.g] || (r[d.g] = []), r[d.g].include(d)
		}
		return r
	}, flatten_data: function (data, filters, w)
	{
		var v_c = mapconf.visegrad, f_c = filter_countries, d = [], p = {}, countries = {};
		switch (w)
		{
			case 0:
				for (var i = 0; i < data.length; i++)
				{
					var dx = data[i], pid = dx.s;
					p[pid] || (p[pid] = {s: dx.s, lat: dx.lat, lon: dx.lon, c: dx.c});
					var dt = dx.data;
					for (var pt_year in dt)for (var y_d = dt[pt_year], j = 0; j < y_d.length; j++)
					{
						var fd = y_d[j], f_tp = [];
						if (fd.c)for (var k = 0; k < fd.c.length; k++)f_tp[k] = String.from(fd.c[k]);
						var o = {
							pt_id: pid,
							city: dx.s,
							country: dx.c,
						...
						d.include(o), countries[dx.c] || (countries[dx.c] = !0)
					}
				}
				break;
			case 1:
				for (var g_countries = {}, i = 0; i < data.length; i++)
				{
					var dx = data[i], pid = dx.s;
					p[pid] || (p[pid] = {s: dx.s, lat: dx.lat, lon: dx.lon, c: dx.c});
					var dt = dx.data;
					for (var pt_year in dt)for (var y_d = dt[pt_year], j = 0; j < y_d.length; j++)
					{
						...
						for (var cpid in fd)
						{
							...
							d.include(o), g_countries[cpid] || (g_countries[cpid] = !0)
						}
						countries[dx.c] || (countries[dx.c] = !0)
					}
				}
				var r_countries = {}, gr_countries = {};
				for (var pid in f_c)(v_c.contains(pid) || g_countries[pid]) && (r_countries[pid] = f_c[pid], gr_countries[pid] = {
					n: f_c[pid],
					d: ""
				});
				filters.g = r_countries, filters.gc = gr_countries;
				break;
			case 2:
				for (var g_countries = {}, i = 0; i < data.length; i++)
				{
					...
					for (var pt_year in dt)for (var y_d = dt[pt_year], j = 0; j < y_d.length; j++)
					{
						...
						d.include(o), countries[fd.ci] || (countries[fd.ci] = !0), g_countries[dx.c] || (g_countries[dx.c] = !0)
					}
				}
				var r_countries = {};
				for (var pid in f_c)(v_c.contains(pid) || g_countries[pid]) && (r_countries[pid] = f_c[pid]);
				filters.g = r_countries
		}
		var f_countries = {};
		for (var pid in f_c)(v_c.contains(pid) || countries[pid]) && (f_countries[pid] = f_c[pid]);
		filters.countries = f_countries;
		var ret = {filters: filters, data: d, points: p};
		return ret
	}
};
!function ()
		...
		filterOn: function (fields)
		{
			return this.filter(function (item)
			{
				...
				for (var pid in fields)
				{
					...
					{
						case"countries":
							if (!a.contains(item.country))return ret = !1;
							break;
						case"years":
							if (!a.contains(item.year))return ret = !1;
							break;
						case"tags":
							for (var b = [], i = 0; i < item.c.length; i++)a.contains(item.c[i]) && b.include(item.c[i]);
							if (0 == b.length)return ret = !1;
							break;
						case"types":
							if (!a.contains(item.g))return ret = !1
					}
				}
				return ret
			})
...
var FilterWin = new Class({
	...
	initialize: function (el, options)
	{
		this.setOptions(options), this.visible = !1, this.el = el;
		var b = el.getElement("a.switch");
		b.addEvent("click", this.sw.bind(this)), this.switches = el.getElements("a.g-switch"), this.bind_switches()
	},
	bind_switches: function ()
	{
		for (var s = this.switches, i = 0; i < s.length; i++)s[i].addEvent("click", this.switch_grants.bind(this, i));
		this.switch_tabs(this.options.current_switch)
	},
	switch_grants: function (i, e)
	{
		e && e.stop(), i != this.options.current_switch ? (this.options.current_switch = i, this.switch_tabs(i), this.show()) : this.sw()
	},
	switch_tabs: function (i)
	{
		for (var s = this.switches, j = 0; j < s.length; j++)j == i ? (s[j].removeClass("dark-bg"), s[j].addClass("light-bg")) : (s[j].removeClass("light-bg"), s[j].addClass("dark-bg"));
		this.fireEvent("typeswitch", this.options.current_switch)
	},
	sw: function (e)
	{
		switch (e && e.stop(), this.visible)
		{
			case!0:
				this.hide();
				break;
	...
	show: function ()
	{
		this.visible = !0, this.el.addClass("visible")
	},
	hide: function ()
	{
		this.visible = !1, this.el.removeClass("visible")
	}
}), GraphMarker = new Class({
	Implements: [Events, Options], options: {pane: null}, initialize: function (pt, map, graph_f, options)
	{
		this.setOptions(options), this.pt = pt, this.graph_f = graph_f;
		var o = this.options;
		this.tooltip_visible = !1;
		var el = new Element("div", {
			styles: {title: pt.s, position: "absolute", "z-index": 998},
			events: {mouseenter: this.to_front.bind(this), mouseleave: this.to_back.bind(this)}
		}).inject(o.pane), g_el = new Element("div", {
			styles: {
				position: "absolute",
				width: 200,
				height: 200,
		...
		}).inject(el), g_f = graph_f.c;
		graph_f.gc && (g_f = graph_f.gc);
		var g_d = {graph_data: pt.data, graph_descs: g_f, graph_group: "c", unit: 0};
		this.g = new PieGraph(g_el, g_d), new Element("div", {
			html: "<div><header>" + pt.pt.s + "</header></div><div>" + pt.data.length + "</div>",
			"class": "graph-inner",
			events: {click: this.destroy.bind(this, map)}
		}).inject(el), this.el = el, this.reposition(map), map.on("zoomstart", this.before_zoom.bind(this)), map.on("zoomend", this.reposition.bind(this, map)), this.fireEvent("create", pt)
	}, before_zoom: function ()
	{
		this.el.setStyles({display: "none"})
	}, reposition: function (map)
	{
		var pt = this.pt, ps = map.latLngToLayerPoint([pt.pt.lat, pt.pt.lon]);
		this.el.setStyles({display: "block", transform: "translate3d(" + ps.x + "px, " + ps.y + "px, 0px)"})
	}, destroy: function (map)
	{
		this.g.destroy(), this.el.destroy(), map.off("zoomstart", this.before_zoom.bind(this)), map.off("zoomend", this.reposition.bind.bind(this, map)), this.fireEvent("destroy"), this.removeEvents()
	}, to_front: function ()
	{
		this.el.setStyles({"z-index": 999})
	}, to_back: function ()
	{
		this.el.setStyles({"z-index": 998})
	}
	...
	{
		this.el.empty(), this.el.set("html", m)
	}
}), PageScroller = new Class({
	Implements: [Events, Options], initialize: function (els, options)
	{
		for (var titles = [], i = 0; i < els.length; i++)titles[i] = els[i].get("title");
		this.titles = titles, this.els = els, this.s = 0, this.classes = [
			"el el-arrow-up scroll-btn pure-button light-bg",
			"el el-arrow-down scroll-btn pure-button light-bg"
		], this.setOptions(options), this.build_html(), this.recalculate(), window.addEvents({
			resize: this.recalculate.bind(this),
			scroll: this.recalculate.bind(this)
		})
	}, build_html: function ()
	{
		for (var c = this.classes, s = [], w = new Element("div", {"class": "page-scroller"}).inject(document.body), i = 0; 2 > i; i++)s[i] = new Element("i", {
			"class": c[i],
	...
	}, sc_clicked: function (i, e)
	{
		...
		0 > s && (s = 0), s >= this.els.length && (s = this.els.length - 1), this.scroll_to(s)
	}, scroll_to: function (i)
	{
		i != this.s && (new Fx.Scroll(window).toElement(this.els[i], "y"), this.s = i)
	}, recalculate: function ()
	{
		for (var els = this.els, ws = window.getScroll(), s = 0, i = 0; i < els.length; i++)
		{
			var c = els[i].getCoordinates();
			ws.y >= c.top && (s = i)
		}
		0 >= s ? this.c[0].addClass("c-hidden") : (this.c[0].set("title", this.titles[s - 1]), this.c[0].removeClass("c-hidden")), s >= this.els.length - 1 ? this.c[1].addClass("c-hidden") : (this.c[1].set("title", this.titles[s + 1]), this.c[1].removeClass("c-hidden")), this.s = s
	}
}), PieGraph = new Class({
	Implements: [Events, Options], initialize: function (el, data, options)
	{
		this.data = data, this.setOptions(options);
		var g_data = this.mk_graph(data);
		this.g_data = g_data, this.tips = new Tips;
		var g = new Chartist.Pie(el, {series: g_data.g}, {donut: !0, donutWidth: 50, showLabel: !1});
		g.on("created", this.graph_bind_events.bind(this, el))
	}, get_g_data: function ()
	{
		return this.g_data
	...
	{
		var gr = data.graph_group, unit = data.unit;
		this.gr = gr;
		var c_d;
		switch (gr)
		{
		...
		for (var c = [], d = [], i = 0; i < s.length; i++)c.include({
			data: s[i].p,
	...
	{
		for (var d = this.data.graph_descs, gr = this.gr, p = this.g_data.g, map = this.g_data.d, u = this.g_data.u, s = el.getElements(".ct-series"), l = s.length, l1 = l - 1, i = 0; l > i; i++)
		{
			var j = l1 - i, ad = ": " + p[j].data.round(2) + "% (" + (0 === u ? "of total projects" : "of total money") + ")";
			switch (gr)
			{
				case"c":
					s[i].store("tip:title", d[map[j]].n + ad), s[i].store("tip:text", d[map[j]].d);
					break;
				case"g":
		...
		this.tips && this.tips.attach(s)
	}, destroy: function ()
	{
		this.tips.destroy()
	}
}), PlaceFilter = new Class({
	Implements: [Events, Options], initialize: function (data, filterdata, options)
	{
		this.setOptions(options), this.created_filter = {years: !1, countries: !1, types: !1, tags: !1};
		var p = $("filter_pane");
		this.select_filters = [
			"countries",
			"types",
			"tags"
		], this.cc_s = 0, this.sel_filter = 0, this.msg = {}, this.data = data, this.p_data = [], this.f_data = [], this.f_points = [], this.f_filters = {}, this.filterdata = filterdata, this.pref = [], this.filtered_data = [], this.year_sel = new YearSel($$("ul.years")[0], mapconf.year_bounds, {onRangechanged: this.filter_years.bind(this)}), this.build_selects(p), new FilterWin(p, {onTypeswitch: this.switch_data.bind(this)})
	}, check_created: function ()
	{
		var c = this.created_filter, created = !0;
		for (var pid in c)0 == c[pid] && (created = !1);
		1 == created && this.fireEvent("created")
	}, get_msg: function ()
	{
		var m = "Showing ", msgs = this.msg, m_a = [];
		switch (this.sel_filter)
		{
			case 0:
				for (var pid in msgs)switch (pid)
				{
					case"years":
						m_a[3] = "in " + msgs[pid];
						break;
					case"countries":
						"all" == msgs[pid].m1 ? m_a[1] = "in " + msgs[pid].m1 + " " + pid : m_a[1] = "in " + msgs[pid].m2;
						break;
					case"types":
						"all" == msgs[pid].m1 ? m_a[0] = "" + msgs[pid].m1 + " grants" : m_a[0] = "" + msgs[pid].m1 + " grants";
						break;
					case"tags":
						"all" == msgs[pid].m1 ? m_a[2] = "in " + msgs[pid].m1 + " fields" : m_a[2] = "in the field(s) <i>" + msgs[pid].m1 + "</i>"
				}
				break;
			case 1:
			...
			case 2:
				...
				for (var pid in msgs)switch (pid)
				{
					case"years":
						...
						break;
					case"countries":
						"all" == msgs[pid].m1 ? m_a[1] = "from " + msgs[pid].m1 + " " + pid : m_a[1] = "from " + msgs[pid].m2;
						break;
					case"types":
						"all" == msgs[pid].m1 ? m_a[0] = "" + msgs[pid].m1 + " countries" : m_a[0] = "" + msgs[pid].m2;
						break;
					case"tags":
						"all" == msgs[pid].m1 ? m_a[2] = "in " + msgs[pid].m1 + " disciplines" : m_a[2] = "in the discipline(s) <i>" + msgs[pid].m1 + "</i>"
				}
		}
		return m += m_a.join(" ")
	}, build_selects: function (el)
	{
		var s = el.getElements("select"), a = el.getElements("a.s-all"), n = el.getElements("a.s-none"), d = this.select_filters, selects = {};
		this.filt_arr = {};
		for (var i = 0; i < s.length; i++)this.filt_arr[d[i]] = [], selects[d[i]] = new SelectFilter(s[i], a[i], n[i], {onFilterchange: this.set_filt_arr.bind(this, d[i])});
		this.selects = selects
	}, set_filt_arr: function (i, d)
	{
		this.msg[i] = d.msg, this.filt_arr[i] = d.filter;
		var prefiltered = this.prefilter();
		this.p_data = prefiltered, this.year_sel.set_data(prefiltered)
	}, switch_data: function (i)
	{
		...
		this.year_sel.set_header(mapconf.year_labels[i]), this.fireEvent("datachanged", i), this.sel_filter = i;
		var s = this.selects, data = this.data, fd = this.filterdata[i];
		this.f_points = data[i].points, this.f_data = data[i].data, this.p_data = [], this.f_filters = fd, fd.countries ? (s.countries.show(), s.countries.set_data(fd.countries), s.countries.set_label(mapconf.filter_labels[i].countries)) : s.countries.hide(), fd.g ? (s.types.show(), s.types.set_data(fd.g), s.types.set_label(mapconf.filter_labels[i].g)) : s.types.hide(), fd.c ? (s.tags.show(), s.tags.set_data(fd.c), s.tags.set_label(mapconf.filter_labels[i].c)) : s.tags.hide()
	}, filter_years: function (y)
	{
		this.msg.years = y.msg;
		var yrs = y.years, d = this.p_data, f = {years: yrs}, tmp_d = d.filterOn(f);
		this.filter(tmp_d)
	}, prefilter: function ()
	{
		var f = this.filt_arr, data = this.f_data, rd = data.filterOn(f);
		if (f.tags && f.tags.length > 0)for (var i = 0; i < rd.length; i++)
		{
			for (var c = [], j = 0; j < rd[i].c.length; j++)
			{
				var cc = rd[i].c[j];
				f.tags.contains(cc) && c.include(cc)
			}
			rd[i].c = c
		}
		return rd
	...
	{
		var msg = this.get_msg(), r = {points: this.f_points, data: data, message: msg, sel: this.sel_filter};
		this.fireEvent("filterchanged", r)
	}
}), SelectFilter = new Class({
	Implements: [Events, Options], initialize: function (el, a, n, options)
	{
		this.created = !1, this.setOptions(options), this.el = el;
		var p = el.getParent();
		this.head = p.getElement("header"), this.s = p.getParent(), this.filter = [], this.els = [], a.addEvent("click", this.select_all.bind(this)), n.addEvent("click", this.select_none.bind(this))
	}, set_label: function (label)
	{
		this.head.set("html", label)
	}, show: function ()
	{
		this.s.setStyles({visibility: "visible"})
	}, hide: function ()
	{
		this.s.setStyles({visibility: "hidden"})
	}, get_message: function ()
	{
		var els = this.els, a = this.filter, r_a = [], r_a_ = [], all = !0, m = "none", m_ = "none";
		for (var pid in els)a.contains(pid) ? (r_a.include(els[pid].get("html")), r_a_.include(countries_geo[pid] && countries_geo[pid].st ? '<span title="' + countries_geo[pid].st + '">' + pid + "</span>" : pid)) : all = !1;
		return 1 == all ? (m = "all", m_ = "all") : r_a.length > 0 && (m = r_a.join(", "), m_ = r_a_.join(", ")), {
			m1: m,
			m2: m_
		}
	}, set_data: function (data)
	{
		this.rebuild(data), this.select_all()
	...
	}, change_filters: function (pid, e)
	{
		e && e.stop();
		var els = this.els;
		1 == els[pid].selected ? els[pid].selected = !1 : els[pid].selected = !0;
		var tmps = [];
		for (var pid in els)1 == els[pid].selected && tmps.push(pid);
		this.filter = tmps, this.select_change()
	}, select_all: function (e)
	{
		e && e.stop();
		var els = this.els, tmps = [];
		for (var pid in els)els[pid].selected = !0, tmps.push(pid);
		this.filter = tmps, this.select_change()
	}, select_none: function (e)
	{
		e && e.stop();
		var els = this.els;
		for (var pid in els)els[pid].selected = !1;
		this.filter = [], this.select_change()
	...
	initiated: !1, first_time: !0, init: function ()
	{
		if (0 == this.initiated)
		{
			new PageScroller($$("section.page-section")), this.initiated = !0;
			for (var dt = [], cities = [], i = 0; i < mapdata.length; i++)dt[i] = DataUtil.flatten_data(mapdata[i], filters[i], i), cities[i] = dt[i].points, filters[i] = dt[i].filters;
			this.msg_win = new MessageWin($("filter-message")), this.map = new AppMap($(mapid), $("map-controls"), mapconf, {
				onGraphcreated: this.draw_graph.bind(this),
				onGraphdestroyed: this.graph_closed.bind(this)
			}), this.graph = new DGraph($("e-graphs")), this.table = new DTable($("e-table")), this.filter = new PlaceFilter(dt, filters, {
	...
	{
		this.graph.set_dtype(i), this.table.set_dtype(i), this.map.set_dtype(i)
	}, draw: function (d)
	{
		this.all_data = d;
		var data = d.data, message = d.message, pts = d.points, sel = d.sel;
		this.msg_win.set_message(message), this.map.draw_points(data, pts, filters[sel]), this.refill(d)
	}, refill: function (d)
	{
		var data = d.data, sel = d.sel;
		this.graph.set_data(data, filters[sel]), this.table.set_data(data)
	}, draw_graph: function (d_in)
	{
		var d = this.all_data, di = {data: d_in.data, sel: d.sel};
		this.refill(di)
...
var YearDrag = new Class({
	Implements: [Events, Options], drags: ["min", "max"], initialize: function (el, divs, options)
	{
		this.setOptions(options);
		var w = el.getParent();
		w.setStyles({position: "relative"});
		for (var el = new Element("div", {
			styles: {
				position: "absolute",
				width: "100%",
				height: "20px",
		...
		}).inject(w), d_w = new Element("div", {
			styles: {
				position: "relative",
				"border-top": "2px solid #000"
			}
		}).inject(el), sliders = [], i = 0; 2 > i; i++)sliders[i] = new Element("a", {
			styles: {
				display: "block",
				width: 20,
				height: 30,
		...
		new YearSlider(d_w, sliders, divs, {onChanged: this.sliders_changed.bind(this)})
	}, sliders_changed: function (range)
	{
		this.fireEvent("changed", range)
	}
}), YearSel = new Class({
	Implements: [Events, Options], initialize: function (el, bounds, options)
	{
		this.created = !1, this.setOptions(options), this.p_d = {
			data: {},
			max: 0
		}, this.head_el = el.getParent().getElement("header"), this.bounds = bounds, this.build_elements(bounds, el), this.data = [], this.drag = new YearDrag(el, this.vals.length, {onChanged: this.change_vals.bind(this)})
	}, set_header: function (t)
	{
		this.head_el.set("html", t)
	}, get_message: function ()
	{
		for (var max, f = this.range, min = f[0], m = "", i = 0; i < f.length; i++)max = Number.from(f[i]);
		return m = min != max ? min + "–" + max : min
	}, build_elements: function (b, el)
	{
		for (var bars = [], vals = [], i = b.min; i <= b.max; i++)
		{
			var li = new Element("li"), y_c = new Element("div", {"class": "year-container"}).inject(li), ba = new Element("div").inject(y_c), va = new Element("div", {
				"class": "year-val",
				text: i
			}).inject(li);
			li.inject(el), vals.include(va), bars.include(ba)
		}
		this.bars = bars, this.vals = vals
	}, set_data: function (data)
	{
		this.p_d = this.prepare_data(DataUtil.group_by_year(data)), this.redraw_divs(), 0 == this.created && (this.created = !0, this.fireEvent("filtercreated"))
	}, redraw_divs: function ()
	{
		for (var bars = this.bars, vals = this.vals, lim = this.limit, f = [], dt = this.p_d, data = dt.data, m = dt.max / 100, i = 0; i < vals.length; i++)
		{
			var y = vals[i].get("text"), v = 0, hg = 0, t = "";
			data[y] && (v = data[y].length), v > 0 && (hg = v / m, t = String.from(v)), bars[i].set("text", t).setStyles({height: hg + "%"}), i >= lim.min && i < lim.max ? (bars[i].addClass("sel"), f.include(y)) : bars[i].removeClass("sel")
		}
		this.range = f;
		var ret = {years: f, msg: this.get_message()};
		this.fireEvent("rangechanged", ret)
	}, change_vals: function (d)
	{
		this.limit = d, this.redraw_divs()
	}, prepare_data: function (data)
	{
		var max = DataUtil.get_max_len(data);
		return {data: data, max: max}
	}
}), YearSlider = new Class({
	Implements: [Events, Options], initialize: function (wrapper, sliders, divs, options)
	{
		this.setOptions(options), this.w = wrapper, this.sliders = sliders;
		var d = [], l = sliders.length - 1;
		this.bounds = {}, this.bounds.divs = divs;
		for (var i = 0; l + 1 > i; i++)d[i] = new Drag(sliders[i], {onComplete: this.snap.bind(this, i)});
		this.drags = d, this.slidersel = [
			0,
			divs
		], this.set_size(), this.chng(), window.addEvent("resize", this.set_size.bind(this))
	}, set_size: function ()
	{
		for (var wrapper = this.w, w_s = wrapper.getSize(), divs = this.bounds.divs, grid = Math.round(w_s.x / divs), d = this.drags, sliders = this.sliders, slidersel = this.slidersel, l = sliders.length - 1, i = 0; i < d.length; i++)
		{
			var s_s = sliders[i].getSize(), x = Math.round(s_s.x / 2), y = Math.round(s_s.y / 2), s_p = slidersel[i] * grid - x;
			sliders[i].setStyles({left: s_p});
			var min_x = 0 - x, max_x = w_s.x - x;
			d[i].options.limit = {
				x: [min_x + Math.round(w_s.x / divs) * i, max_x - Math.round(w_s.x / divs) * (l - i)],
				y: [0 - y, 0 - y]
			}, d[i].options.grid = grid
		}
		this.bounds.x = {min: min_x, max: max_x}, this.bounds.grid = grid
	}, snap: function (i, el)
	{
		var b = this.bounds, p = el.getPosition(this.w);
		switch (i)
		{
			case 0:
				this.drags[1].options.limit.x[0] = p.x + b.grid, this.slidersel[0] = Math.round((p.x - b.x.min) / b.grid);
				break;
			case 1:
				this.drags[0].options.limit.x[1] = p.x - b.grid, this.slidersel[1] = Math.round((p.x - b.x.min) / b.grid)
		}
		this.chng()
	}, chng: function ()
	{
		var s = this.slidersel, r = {min: s[0], max: s[1]};
	...
	min_radius: 10,
	max_radius: 60,
	v4_bounds: [[55.0721744, 12.1004461], [45.7268402, 24.1729511]],
	year_bounds: {min: 2e3, max: 2015}
}, mapid = "map-main";