...
var FilterWin = new Class({
	...
	Implements: [Events, Options], initialize: function (data, filterdata, options)
	{
		...
		this.select_filters = [
			...
			"types",
			"tags"
		], this.cc_s = 0, this.msg = {}, this.data = data, this.p_data = [], this.f_data = [], this.f_points = [], this.f_filters = {}, this.filterdata = filterdata, this.pref = [], this.filtered_data = [], this.year_sel = new YearSel($$("ul.years")[0], mapconf.year_bounds, {onRangechanged: this.filter_years.bind(this)}), this.build_selects(p), new FilterWin(p, {onTypeswitch: this.switch_data.bind(this)})
